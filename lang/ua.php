...
class lang {
	...
	const ERR_PHONE = 'Напишіть телефон у форматі 380ххххххххх будь-ласка';
	...
	const SUCCESS_NEW_VISIT = 'Дякую! Вашу заявку отримано. <br />Очікуйте на підтвердження';
	const BTN_ENTER = 'Войти';
	const BTN_DONE = 'Готово';
	const BTN_CANCEL = 'Отмена';
	const BTN_CLIENT_VISIT = 'Записатись';
