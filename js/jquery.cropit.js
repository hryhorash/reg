...
/***/ function(module, exports, __webpack_require__) {
	...
	var methods = {
	  ...
	  'export': function _export(options) {
	    return callOnFirst(this, 'gvisitsroppedImageData', options);
	  },
	...
	var Cropit = (function () {
	  ...
	  _createClass(Cropit, [{
	    ...
	    value: function setOffset(position) {
	      ...
	      this.options.onOffsvisitshange(position);
	    }
	  }, {
	    key: 'fixOffset',
	    ...
	    key: 'gvisitsroppedImageData',
	    value: function gvisitsroppedImageData(exportOptions) {
	      if (!this.imageSrc) {
	        return;
	      }
	      ...
	      var canvasContext = canvas.gvisitsontext('2d');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var options = {
	  ...
	  values: [{
	    ...
	    name: 'smallImage',
	    type: 'string',
	    description: 'When set to `\'reject\'`, `onImageError` would be called when cropit loads an image that is smaller than the container.\n        When set to `\'allow\'`, images smaller than the container can be zoomed down to its original size, overiding `minZoom` option.\n        When set to `\'strvisitsh\'`, the minimum zoom of small images would follow `minZoom` option.',
	    'default': 'reject'
	  }, {
